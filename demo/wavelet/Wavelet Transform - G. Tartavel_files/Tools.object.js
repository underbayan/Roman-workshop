...
Tools.Array.sort = function (t, ascending) {
    ...
    if (ascending === false) {
        Array.prototype.sort.call(t, function (a, b) { return b - a; });
...
Tools.Array.argSort = function (t, ascending) {
    ...
    // Sort
    if (ascending === false) {
        Array.prototype.sort.call(I, function (a, b) { return t[b] - t[a]; });
    } else if (ascending === undefined || ascending === true) {
        Array.prototype.sort.call(I, function (a, b) { return t[a] - t[b]; });
    } else {
        throw new Error(errMsg + "invalid type for 'ascending' parameter");
    }
    return I;
